            ...
            <ul class="nav navbar-nav" style="margin-left: 270px">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="${contextPath}/student/createKhoaHoc">Đăng ký</a></li>
                    </ul>
                </li>
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
                        aria-expanded="false">Lop hoc
                        <span class="caret"></span></a>
                    <ul class="dropdown-menu">
                        <li><a href="${contextPath}/lophoc/list">List Lop Hoc</a></li>
                        <li><a href="${contextPath}/lophoc/create">Create Lop Hoc</a></li>
                    </ul>
                </li>
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
                        aria-expanded="false">Khoa hoc
                        <span class="caret"></span></a>
                    <ul class="dropdown-menu">
                        <li><a href="${contextPath}/khoahoc/list">List Khoa Hoc</a></li>
                        <li><a href="${contextPath}/khoahoc/create">Create Khoa Hoc</a></li>
                    </ul>
                </li>
            </ul>
